...
namespace Gythian_ExtraPsychicRituals
{
    ...
    public class PsychicRitualDef_ProliferationPulse : PsychicRitualDef_InvocationCircle
    {
          ...
          PsychicRitualGraph graph)
        {
            ...
            toils.Add((PsychicRitualToil)new PsychicRitualToil_ProliferationPulse(this.InvokerRole));
            return toils;
        }
